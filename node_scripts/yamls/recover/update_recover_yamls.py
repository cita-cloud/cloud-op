...
RECOVER_NODE_SC = os.getenv("RECOVER_NODE_SC")
SHARE_SC = os.getenv("SHARE_SC")

BACKUP_NODE = os.getenv("BACKUP_NODE")
RECOVER_NODE = os.getenv("RECOVER_NODE")
...
yaml_data["metadata"]["name"] = "datadir-" + RECOVER_NODE
yaml_data["spec"]["storageClassName"] = RECOVER_NODE_SC
...
yaml_data["spec"]["template"]["spec"]["containers"][0]["volumeMounts"][0]["name"] = (
    "datadir-" + RECOVER_NODE
)
yaml_data["spec"]["template"]["spec"]["volumes"][1]["name"] = "datadir-" + RECOVER_NODE
yaml_data["spec"]["template"]["spec"]["volumes"][1]["persistentVolumeClaim"][
    "claimName"
] = ("datadir-" + RECOVER_NODE)
